...
class FileServiceImplTest {
    ...
    void uploadFiles_ShouldUploadFilesSuccessfully() {
        ...
        fileServiceImpl.uploadFiles(user.getId(), workspace.getId(), List.of(multipartFile));
    ...
    void deleteFile_ShouldDeleteFileSuccessfully() {
        ...
        fileServiceImpl.deleteFile(fileId, workspace.getId(), user.getId());
    ...
    void downloadFile_ShouldReturnFileContent() {
        ...
        var result = fileServiceImpl.downloadFile(fileId, workspace.getId(), user.getId());
    ...
    void downloadFile_ShouldThrowException_WhenUserNotLinkedToWorkspace() {
        ...
        var exception = assertThrows(ServiceException.class,
                () -> fileServiceImpl.downloadFile(fileId, workspace.getId(), user.getId()));
    ...
    void getFilesInfo_ShouldThrowException_WhenUserNotLinkedToWorkspace() {
        ...
        var exception = assertThrows(ServiceException.class,
                () -> fileServiceImpl.getFilesInfo(user.getId(), workspace.getId(), pageRequest));
